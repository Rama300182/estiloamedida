document.addEventListener('DOMContentLoaded', function() {
    // Inicializar funcionalidad de placards
    initPlacards();
});
...
function setupFilters() {
    ...
    console.log('Filtros de placards configurados');
}
...
window.mostrarDetalleProducto = function(producto) {
    console.log('Mostrando detalles del placard:', producto);
    ...
    mainImage.src = producto.imagen_principal || 'image/placards/default.jpg';
    ...
    const specs = [
        { label: 'Categoría', value: 'Placards' },
...
function setupModal() {
    ...
    contactBtn.addEventListener('click', function() {
        ...
        const message = `Hola! Me interesa el placard: ${productName}. ¿Podrían darme más información?`;
...
style.textContent = `
    ...
    /* Efecto de hover mejorado para placards */
    .product-card:hover {
...
window.debugPlacards = function() {
    console.log('=== DEBUG PLACARDS ===');
...
console.log('Placard.js cargado correctamente ✅');